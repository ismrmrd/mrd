...
PATH="${WORKSPACE}/cpp/build:$PATH"
PYTHONPATH="${WORKSPACE}/python:$PYTHONPATH"
MATLABPATH="${WORKSPACE}/matlab/toolbox:${WORKSPACE}/matlab/toolbox/examples:$MATLABPATH"
...
ifmatlab && run-matlab-command 'generate_phantom("phantom.mat.mrd", "ncoils", 14, "matrix_size", 260, "repetitions", 2, "acceleration", 1, "noise_level", 0, "noise_calibration", true, "store_coordinates", true, "output_coils", "coil_images.mat.mrd")'
