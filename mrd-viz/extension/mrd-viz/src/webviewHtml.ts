...
<body>
	<main>
		...
		<p>MRD Viz needs a Python 3.12 backend, but none of these candidates worked:</p>
		<ul>${triedItems}</ul>
		<div class="actions">
		...
		<p><strong>Set Up Backend…</strong> can create a managed backend automatically or install from a local wheel in the release bundle.</p>
	</main>
	<script nonce="${nonce}">
		(function () {
