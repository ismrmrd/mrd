...
namespace mrd::hdf5 {
namespace {
[[maybe_unused]] H5::EnumType GetGradientDirectionHdf5Ddl() {
...
struct _Inner_GradientHeader {
  ...
  _Inner_GradientHeader(mrd::GradientHeader const& o) 
      ...
      gradient_direction(o.gradient_direction) {
  }
  ...
  void ToOuter (mrd::GradientHeader& o) const {
    ...
    yardl::hdf5::ToOuter(gradient_direction, o.gradient_direction);
  }
...
[[maybe_unused]] H5::CompType GetGradientHeaderHdf5Ddl() {
  ...
  t.insertMember("gradientDirection", HOFFSET(RecordType, gradient_direction), mrd::hdf5::GetGradientDirectionHdf5Ddl());
  return t;
}
