...
struct _Inner_AcquisitionPrototype {
  _Inner_AcquisitionPrototype() {} 
  _Inner_AcquisitionPrototype(mrd::AcquisitionPrototype const& o) 
      : head(o.head),
      data_sample_counts(o.data_sample_counts) {
  }

  void ToOuter (mrd::AcquisitionPrototype& o) const {
    yardl::hdf5::ToOuter(head, o.head);
    yardl::hdf5::ToOuter(data_sample_counts, o.data_sample_counts);
  }

  mrd::hdf5::_Inner_AcquisitionHeader head;
  yardl::hdf5::InnerVlen<uint32_t, uint32_t> data_sample_counts;
};
...
struct _Inner_PulseqShape {
  _Inner_PulseqShape() {} 
  _Inner_PulseqShape(mrd::PulseqShape const& o) 
      : id(o.id),
      num_samples(o.num_samples),
      data(o.data) {
  }

  void ToOuter (mrd::PulseqShape& o) const {
...
[[maybe_unused]] H5::CompType GetAcquisitionPrototypeHdf5Ddl() {
  using RecordType = mrd::hdf5::_Inner_AcquisitionPrototype;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("head", HOFFSET(RecordType, head), mrd::hdf5::GetAcquisitionHeaderHdf5Ddl());
  t.insertMember("dataSampleCounts", HOFFSET(RecordType, data_sample_counts), yardl::hdf5::InnerVlenDdl(H5::PredType::NATIVE_UINT32));
  return t;
}
...
[[maybe_unused]] H5::CompType GetPulseqBlockHdf5Ddl() {
  using RecordType = mrd::PulseqBlock;
  H5::CompType t(sizeof(RecordType));
...
[[maybe_unused]] H5::CompType GetPulseqRFEventHdf5Ddl() {
  using RecordType = mrd::PulseqRFEvent;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("id", HOFFSET(RecordType, id), H5::PredType::NATIVE_INT32);
...
[[maybe_unused]] H5::CompType GetPulseqArbitraryGradientHdf5Ddl() {
  using RecordType = mrd::PulseqArbitraryGradient;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("id", HOFFSET(RecordType, id), H5::PredType::NATIVE_INT32);
  t.insertMember("amp", HOFFSET(RecordType, amp), H5::PredType::NATIVE_DOUBLE);
...
[[maybe_unused]] H5::CompType GetPulseqTrapezoidalGradientHdf5Ddl() {
  using RecordType = mrd::PulseqTrapezoidalGradient;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("id", HOFFSET(RecordType, id), H5::PredType::NATIVE_INT32);
  t.insertMember("amp", HOFFSET(RecordType, amp), H5::PredType::NATIVE_DOUBLE);
...
[[maybe_unused]] H5::CompType GetPulseqADCEventHdf5Ddl() {
  using RecordType = mrd::PulseqADCEvent;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("id", HOFFSET(RecordType, id), H5::PredType::NATIVE_INT32);
...
[[maybe_unused]] H5::CompType GetPulseqShapeHdf5Ddl() {
  using RecordType = mrd::hdf5::_Inner_PulseqShape;
  H5::CompType t(sizeof(RecordType));
  t.insertMember("id", HOFFSET(RecordType, id), H5::PredType::NATIVE_INT32);
...
void MrdWriter::WriteDataImpl(mrd::StreamItem const& value) {
  if (!data_dataset_state_) {
    data_dataset_state_ = std::make_unique<yardl::hdf5::UnionDatasetWriter<29>>(group_, "data", false, std::make_tuple(mrd::hdf5::GetAcquisitionHdf5Ddl(), "acquisition", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetAcquisitionPrototypeHdf5Ddl(), "acquisitionPrototype", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetWaveformHdf5Ddl<uint32_t, uint32_t>(H5::PredType::NATIVE_UINT32), "waveformUint32", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<uint16_t, uint16_t>(H5::PredType::NATIVE_UINT16), "imageUint16", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<int16_t, int16_t>(H5::PredType::NATIVE_INT16), "imageInt16", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<uint32_t, uint32_t>(H5::PredType::NATIVE_UINT32), "imageUint32", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<int32_t, int32_t>(H5::PredType::NATIVE_INT32), "imageInt32", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<float, float>(H5::PredType::NATIVE_FLOAT), "imageFloat", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<double, double>(H5::PredType::NATIVE_DOUBLE), "imageDouble", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<std::complex<float>, std::complex<float>>(yardl::hdf5::ComplexTypeDdl<float>()), "imageComplexFloat", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageHdf5Ddl<std::complex<double>, std::complex<double>>(yardl::hdf5::ComplexTypeDdl<double>()), "imageComplexDouble", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetAcquisitionBucketHdf5Ddl(), "acquisitionBucket", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetReconDataHdf5Ddl(), "reconData", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetImageArrayHdf5Ddl(), "imageArray", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqDefinitionsHdf5Ddl(), "pulseqDefinitions", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(yardl::hdf5::InnerVlenDdl(mrd::hdf5::GetPulseqBlockHdf5Ddl()), "pulseqBlocks", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqRFEventHdf5Ddl(), "pulseqRfEvent", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqArbitraryGradientHdf5Ddl(), "pulseqArbitraryGradient", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqTrapezoidalGradientHdf5Ddl(), "pulseqTrapezoidalGradient", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqADCEventHdf5Ddl(), "pulseqAdcEvent", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetPulseqShapeHdf5Ddl(), "pulseqShape", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<uint16_t, uint16_t>(H5::PredType::NATIVE_UINT16), "ndArrayUint16", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<int16_t, int16_t>(H5::PredType::NATIVE_INT16), "ndArrayInt16", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<uint32_t, uint32_t>(H5::PredType::NATIVE_UINT32), "ndArrayUint32", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<int32_t, int32_t>(H5::PredType::NATIVE_INT32), "ndArrayInt32", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<float, float>(H5::PredType::NATIVE_FLOAT), "ndArrayFloat", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<double, double>(H5::PredType::NATIVE_DOUBLE), "ndArrayDouble", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<std::complex<float>, std::complex<float>>(yardl::hdf5::ComplexTypeDdl<float>()), "ndArrayComplexFloat", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))), std::make_tuple(mrd::hdf5::GetNdArrayHdf5Ddl<std::complex<double>, std::complex<double>>(yardl::hdf5::ComplexTypeDdl<double>()), "ndArrayComplexDouble", static_cast<size_t>(std::max(sizeof(::InnerUnion29<mrd::hdf5::_Inner_Acquisition, mrd::Acquisition, mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype, mrd::hdf5::_Inner_Waveform<uint32_t, uint32_t>, mrd::WaveformUint32, mrd::hdf5::_Inner_Image<uint16_t, uint16_t>, mrd::ImageUint16, mrd::hdf5::_Inner_Image<int16_t, int16_t>, mrd::ImageInt16, mrd::hdf5::_Inner_Image<uint32_t, uint32_t>, mrd::ImageUint32, mrd::hdf5::_Inner_Image<int32_t, int32_t>, mrd::ImageInt32, mrd::hdf5::_Inner_Image<float, float>, mrd::ImageFloat, mrd::hdf5::_Inner_Image<double, double>, mrd::ImageDouble, mrd::hdf5::_Inner_Image<std::complex<float>, std::complex<float>>, mrd::ImageComplexFloat, mrd::hdf5::_Inner_Image<std::complex<double>, std::complex<double>>, mrd::ImageComplexDouble, mrd::hdf5::_Inner_AcquisitionBucket, mrd::AcquisitionBucket, mrd::hdf5::_Inner_ReconData, mrd::ReconData, mrd::hdf5::_Inner_ImageArray, mrd::ImageArray, mrd::hdf5::_Inner_PulseqDefinitions, mrd::PulseqDefinitions, yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqADCEvent, mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape, mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16, mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16, mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32, mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32, mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat, mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble, mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat, mrd::hdf5::_Inner_NdArray<std::complex<double>, std::complex<double>>, mrd::NdArrayComplexDouble>), sizeof(std::variant<mrd::Acquisition, mrd::AcquisitionPrototype, mrd::WaveformUint32, mrd::ImageUint16, mrd::ImageInt16, mrd::ImageUint32, mrd::ImageInt32, mrd::ImageFloat, mrd::ImageDouble, mrd::ImageComplexFloat, mrd::ImageComplexDouble, mrd::AcquisitionBucket, mrd::ReconData, mrd::ImageArray, mrd::PulseqDefinitions, std::vector<mrd::PulseqBlock>, mrd::PulseqRFEvent, mrd::PulseqArbitraryGradient, mrd::PulseqTrapezoidalGradient, mrd::PulseqADCEvent, mrd::PulseqShape, mrd::NdArrayUint16, mrd::NdArrayInt16, mrd::NdArrayUint32, mrd::NdArrayInt32, mrd::NdArrayFloat, mrd::NdArrayDouble, mrd::NdArrayComplexFloat, mrd::NdArrayComplexDouble>)))));
  }
  ...
  std::visit(
    [&](auto const& arg) {
      ...
      } else if constexpr (std::is_same_v<T, mrd::AcquisitionPrototype>) {
        data_dataset_state_->Append<mrd::hdf5::_Inner_AcquisitionPrototype, mrd::AcquisitionPrototype>(static_cast<int8_t>(value.index()), arg);
      ...
      } else if constexpr (std::is_same_v<T, std::vector<mrd::PulseqBlock>>) {
        data_dataset_state_->Append<yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>>(static_cast<int8_t>(value.index()), arg);
      } else if constexpr (std::is_same_v<T, mrd::PulseqRFEvent>) {
        data_dataset_state_->Append<mrd::PulseqRFEvent, mrd::PulseqRFEvent>(static_cast<int8_t>(value.index()), arg);
      } else if constexpr (std::is_same_v<T, mrd::PulseqArbitraryGradient>) {
        data_dataset_state_->Append<mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient>(static_cast<int8_t>(value.index()), arg);
      } else if constexpr (std::is_same_v<T, mrd::PulseqTrapezoidalGradient>) {
        data_dataset_state_->Append<mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient>(static_cast<int8_t>(value.index()), arg);
      } else if constexpr (std::is_same_v<T, mrd::PulseqADCEvent>) {
        data_dataset_state_->Append<mrd::PulseqADCEvent, mrd::PulseqADCEvent>(static_cast<int8_t>(value.index()), arg);
      } else if constexpr (std::is_same_v<T, mrd::PulseqShape>) {
        data_dataset_state_->Append<mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape>(static_cast<int8_t>(value.index()), arg);
...
bool MrdReader::ReadDataImpl(mrd::StreamItem& value) {
  ...
  case 15: {
    std::vector<mrd::PulseqBlock>& ref = value.emplace<15>();
    reader->Read<yardl::hdf5::InnerVlen<mrd::PulseqBlock, mrd::PulseqBlock>, std::vector<mrd::PulseqBlock>>(ref);
    break;
  }
  case 16: {
    mrd::PulseqRFEvent& ref = value.emplace<16>();
    reader->Read<mrd::PulseqRFEvent, mrd::PulseqRFEvent>(ref);
    break;
  }
  case 17: {
    mrd::PulseqArbitraryGradient& ref = value.emplace<17>();
    reader->Read<mrd::PulseqArbitraryGradient, mrd::PulseqArbitraryGradient>(ref);
    break;
  }
  case 18: {
    mrd::PulseqTrapezoidalGradient& ref = value.emplace<18>();
    reader->Read<mrd::PulseqTrapezoidalGradient, mrd::PulseqTrapezoidalGradient>(ref);
    break;
  }
  case 19: {
    mrd::PulseqADCEvent& ref = value.emplace<19>();
    reader->Read<mrd::PulseqADCEvent, mrd::PulseqADCEvent>(ref);
    break;
  }
  case 20: {
    mrd::PulseqShape& ref = value.emplace<20>();
    reader->Read<mrd::hdf5::_Inner_PulseqShape, mrd::PulseqShape>(ref);
    break;
  }
  case 21: {
    mrd::NdArrayUint16& ref = value.emplace<21>();
    reader->Read<mrd::hdf5::_Inner_NdArray<uint16_t, uint16_t>, mrd::NdArrayUint16>(ref);
    break;
  }
  case 22: {
    mrd::NdArrayInt16& ref = value.emplace<22>();
    reader->Read<mrd::hdf5::_Inner_NdArray<int16_t, int16_t>, mrd::NdArrayInt16>(ref);
    break;
  }
  case 23: {
    mrd::NdArrayUint32& ref = value.emplace<23>();
    reader->Read<mrd::hdf5::_Inner_NdArray<uint32_t, uint32_t>, mrd::NdArrayUint32>(ref);
    break;
  }
  case 24: {
    mrd::NdArrayInt32& ref = value.emplace<24>();
    reader->Read<mrd::hdf5::_Inner_NdArray<int32_t, int32_t>, mrd::NdArrayInt32>(ref);
    break;
  }
  case 25: {
    mrd::NdArrayFloat& ref = value.emplace<25>();
    reader->Read<mrd::hdf5::_Inner_NdArray<float, float>, mrd::NdArrayFloat>(ref);
    break;
  }
  case 26: {
    mrd::NdArrayDouble& ref = value.emplace<26>();
    reader->Read<mrd::hdf5::_Inner_NdArray<double, double>, mrd::NdArrayDouble>(ref);
    break;
  }
  case 27: {
    mrd::NdArrayComplexFloat& ref = value.emplace<27>();
    reader->Read<mrd::hdf5::_Inner_NdArray<std::complex<float>, std::complex<float>>, mrd::NdArrayComplexFloat>(ref);
    break;
  }
  case 28: {
    mrd::NdArrayComplexDouble& ref = value.emplace<28>();
