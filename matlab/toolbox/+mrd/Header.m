  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.version] == [other.version]) && ...
        all([self.subject_information] == [other.subject_information]) && ...
        all([self.study_information] == [other.study_information]) && ...
        all([self.measurement_information] == [other.measurement_information]) && ...
        all([self.acquisition_system_information] == [other.acquisition_system_information]) && ...
        all([self.experimental_conditions] == [other.experimental_conditions]) && ...
        all([self.encoding] == [other.encoding]) && ...
        all([self.sequence_parameters] == [other.sequence_parameters]) && ...
        all([self.user_parameters] == [other.user_parameters]) && ...
        all([self.waveform_information] == [other.waveform_information]);
    end
