  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.t_r] == [other.t_r]) && ...
        all([self.t_e] == [other.t_e]) && ...
        all([self.t_i] == [other.t_i]) && ...
        all([self.flip_angle_deg] == [other.flip_angle_deg]) && ...
        all([self.sequence_type] == [other.sequence_type]) && ...
        all([self.echo_spacing] == [other.echo_spacing]) && ...
        all([self.diffusion_dimension] == [other.diffusion_dimension]) && ...
        all([self.diffusion] == [other.diffusion]) && ...
        all([self.diffusion_scheme] == [other.diffusion_scheme]);
    end
