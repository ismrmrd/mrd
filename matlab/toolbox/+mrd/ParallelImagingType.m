  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.acceleration_factor] == [other.acceleration_factor]) && ...
        all([self.calibration_mode] == [other.calibration_mode]) && ...
        all([self.interleaving_dimension] == [other.interleaving_dimension]) && ...
        all([self.multiband] == [other.multiband]);
    end
