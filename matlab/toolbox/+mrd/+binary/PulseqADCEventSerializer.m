...
classdef PulseqADCEventSerializer < yardl.binary.RecordSerializer
  methods
    function self = PulseqADCEventSerializer()
      ...
      self@yardl.binary.RecordSerializer('mrd.PulseqADCEvent', field_serializers);
    end
    ...
    function value = read(self, instream)
      ...
      value = mrd.PulseqADCEvent(id=fields{1}, num=fields{2}, dwell=fields{3}, delay=fields{4}, freq_ppm=fields{5}, phase_ppm=fields{6}, freq=fields{7}, phase=fields{8}, phase_shape_id=fields{9});
    end
  end
end
