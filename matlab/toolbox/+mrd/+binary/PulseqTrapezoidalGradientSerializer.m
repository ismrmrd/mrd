...
classdef PulseqTrapezoidalGradientSerializer < yardl.binary.RecordSerializer
  methods
    function self = PulseqTrapezoidalGradientSerializer()
    ...
    function write(self, outstream, value)
      arguments
        ...
        value (1,1) mrd.PulseqTrapezoidalGradient
      end
    ...
    function value = read(self, instream)
      ...
      value = mrd.PulseqTrapezoidalGradient(id=fields{1}, amp=fields{2}, rise=fields{3}, flat=fields{4}, fall=fields{5}, delay=fields{6});
    end
  end
end
