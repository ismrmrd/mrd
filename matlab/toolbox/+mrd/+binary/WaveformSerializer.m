...
classdef WaveformSerializer < yardl.binary.RecordSerializer
  methods
    function self = WaveformSerializer(t_serializer)
      ...
      field_serializers{4} = yardl.binary.Uint32Serializer;
      field_serializers{5} = yardl.binary.Float32Serializer;
    ...
    function write(self, outstream, value)
      ...
      self.write_(outstream, value.flags, value.measurement_uid, value.scan_counter, value.time_stamp, value.sample_time_us, value.waveform_id, value.data);
    end

    function value = read(self, instream)
      fields = self.read_(instream);
      value = mrd.Waveform(flags=fields{1}, measurement_uid=fields{2}, scan_counter=fields{3}, time_stamp=fields{4}, sample_time_us=fields{5}, waveform_id=fields{6}, data=fields{7});
    end
  end
end
