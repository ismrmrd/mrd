...
classdef PulseqArbitraryGradientSerializer < yardl.binary.RecordSerializer
  methods
    function self = PulseqArbitraryGradientSerializer()
    ...
    function write(self, outstream, value)
      arguments
        ...
        value (1,1) mrd.PulseqArbitraryGradient
      end
    ...
    function value = read(self, instream)
      ...
      value = mrd.PulseqArbitraryGradient(id=fields{1}, amp=fields{2}, first=fields{3}, last=fields{4}, shape_id=fields{5}, time_id=fields{6}, delay=fields{7});
    end
  end
end
