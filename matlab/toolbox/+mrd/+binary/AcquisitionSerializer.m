...
classdef AcquisitionSerializer < yardl.binary.RecordSerializer
  methods
    function self = AcquisitionSerializer()
      ...
      field_serializers{20} = yardl.binary.NDArraySerializer(yardl.binary.Complexfloat32Serializer, 2);
      field_serializers{21} = yardl.binary.NDArraySerializer(yardl.binary.Float32Serializer, 2);
    ...
    function value = read(self, instream)
      ...
      value = mrd.Acquisition(flags=fields{1}, idx=fields{2}, measurement_uid=fields{3}, scan_counter=fields{4}, acquisition_time_stamp=fields{5}, physiology_time_stamp=fields{6}, channel_order=fields{7}, discard_pre=fields{8}, discard_post=fields{9}, center_sample=fields{10}, encoding_space_ref=fields{11}, sample_time_us=fields{12}, position=fields{13}, read_dir=fields{14}, phase_dir=fields{15}, slice_dir=fields{16}, patient_table_position=fields{17}, user_int=fields{18}, user_float=fields{19}, data=fields{20}, trajectory=fields{21});
    end
  end
end
