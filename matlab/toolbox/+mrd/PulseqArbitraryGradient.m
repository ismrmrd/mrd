...
classdef PulseqArbitraryGradient < handle
  ...
  methods
    function self = PulseqArbitraryGradient(kwargs)
      arguments
        kwargs.id = int32(0);
        kwargs.amp = double(0);
    ...
    function res = eq(self, other)
      res = ...
        isa(other, "mrd.PulseqArbitraryGradient") && ...
  ...
  methods (Static)
    function z = zeros(varargin)
      elem = mrd.PulseqArbitraryGradient();
      if nargin == 0
        z = elem;
        return;
      end
