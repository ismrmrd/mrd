...
classdef StreamItem < yardl.Union
  methods (Static)
    ...
    function res = AcquisitionPrototype(value)
  ...
  methods
    ...
    function res = isAcquisitionPrototype(self)
      res = self.index == 2;
    end
