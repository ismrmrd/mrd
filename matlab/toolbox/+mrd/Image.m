  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.image_type] == [other.image_type]) && ...
        all([self.image_index] == [other.image_index]) && ...
        all([self.image_series_index] == [other.image_series_index]) && ...
        all([self.user_int] == [other.user_int]) && ...
        all([self.user_float] == [other.user_float]) && ...
        isequal(self.data, other.data) && ...
        all([self.meta] == [other.meta]);
    end
