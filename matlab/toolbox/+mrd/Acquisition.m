  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.measurement_uid] == [other.measurement_uid]) && ...
        all([self.scan_counter] == [other.scan_counter]) && ...
        all([self.acquisition_time_stamp] == [other.acquisition_time_stamp]) && ...
        all([self.physiology_time_stamp] == [other.physiology_time_stamp]) && ...
        all([self.channel_order] == [other.channel_order]) && ...
        all([self.discard_pre] == [other.discard_pre]) && ...
        all([self.discard_post] == [other.discard_post]) && ...
        all([self.center_sample] == [other.center_sample]) && ...
        all([self.encoding_space_ref] == [other.encoding_space_ref]) && ...
        all([self.sample_time_us] == [other.sample_time_us]) && ...
        ...
        all([self.user_int] == [other.user_int]) && ...
        all([self.user_float] == [other.user_float]) && ...
