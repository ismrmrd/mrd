  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.identifier] == [other.identifier]) && ...
        all([self.user_parameter_long] == [other.user_parameter_long]) && ...
        all([self.user_parameter_double] == [other.user_parameter_double]) && ...
        all([self.user_parameter_string] == [other.user_parameter_string]) && ...
        all([self.comment] == [other.comment]);
    end
