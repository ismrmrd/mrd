  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.system_vendor] == [other.system_vendor]) && ...
        all([self.system_model] == [other.system_model]) && ...
        all([self.system_field_strength_t] == [other.system_field_strength_t]) && ...
        all([self.relative_receiver_noise_bandwidth] == [other.relative_receiver_noise_bandwidth]) && ...
        all([self.receiver_channels] == [other.receiver_channels]) && ...
        all([self.coil_label] == [other.coil_label]) && ...
        all([self.institution_name] == [other.institution_name]) && ...
        all([self.station_name] == [other.station_name]) && ...
        all([self.device_id] == [other.device_id]) && ...
        all([self.device_serial_number] == [other.device_serial_number]);
    end
