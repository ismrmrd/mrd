  ...
  methods
    ...
    function res = eq(self, other)
      res = ...
        ...
        all([self.measurement_id] == [other.measurement_id]) && ...
        all([self.series_date] == [other.series_date]) && ...
        all([self.series_time] == [other.series_time]) && ...
        all([self.patient_position] == [other.patient_position]) && ...
        all([self.relative_table_position] == [other.relative_table_position]) && ...
        all([self.initial_series_number] == [other.initial_series_number]) && ...
        all([self.protocol_name] == [other.protocol_name]) && ...
        all([self.sequence_name] == [other.sequence_name]) && ...
        all([self.series_description] == [other.series_description]) && ...
        all([self.measurement_dependency] == [other.measurement_dependency]) && ...
        all([self.series_instance_uid_root] == [other.series_instance_uid_root]) && ...
        all([self.frame_of_reference_uid] == [other.frame_of_reference_uid]) && ...
        all([self.referenced_image_sequence] == [other.referenced_image_sequence]);
    end
